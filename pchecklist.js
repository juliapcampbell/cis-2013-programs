...
var passwordCheckOld = function () 
{
   ...
   //for loop that utilizes the array
   {
      ...
      {
         stringOutput = "Error. Password is incorrect.";
         $("password").value = "";
      }
      else
      {
      ...
      if  (stringOutput!= "Your password is too short." && stringOutput!= "Error. Password is incorrect.")
         {
            stringOutput = "Your password is correct.";
            $("password").value = "";
         }
